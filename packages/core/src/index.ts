...
class GT {
  ...
  */
  ...
  /**
   * Formats an ICU message string using the specified variables and locales.
   * @param {string} string - The message string to format.
   * @param {Object} options - The options for formatting the message.
   * @param {Record<string, any>} [options.variables={}] - An object containing variable values.
